...
function DirectFromFarmers({ farmers }) {
    return (
        <section className="py-12 mb-1 bg-violet-50">
            <div className="container mx-auto text-center mb-8">
                <h2 className="text-3xl font-bold text-green-500">Direct from Farmers</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 container mx-auto">
                {farmers.map((farmer) => (
                    <div key={farmer.id} className="bg-white p-6 rounded-lg shadow-lg">
                        ...
                        <button className="mt-4 bg-green-500 text-white py-2 px-4 rounded-md hover:bg-green-500 transition">
                            View Products
                        </button>
                    </div>
                ))}
